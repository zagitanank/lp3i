                ...
                <div class="blog-content col-md-8">
                    ...
                    ?>
                        <div class="single-item">
                            <div class="item">
                                <div class="thumb">
                                    <a href="<?= BASE_URL; ?>/detailpost/<?= $post['seotitle']; ?>"><img src="<?= BASE_URL; ?>/<?= DIR_CON; ?>/uploads/medium/medium_<?= $post['picture']; ?>" alt="Thumb"></a>
                                    <div class="date">
                                ...
                                <div class="info">
                                    ...
                                    <a href="<?= BASE_URL; ?>/detailpost/<?= $post['seotitle']; ?>">Baca Sekarang <i class="fas fa-angle-double-right"></i></a>
                                    <div class="meta">
                                        <ul>
                                            <li>
