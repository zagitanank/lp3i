...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= BASE_URL . '/' . DIR_INC; ?>/akun/css/vendors/animate.css">
    <link rel="stylesheet" type="text/css" href="<?= BASE_URL . '/' . DIR_INC; ?>/akun/css/vendors/photoswipe.css">
    <!-- Plugins css Ends-->
    <?php } ?>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        ...
        <div class="page-header">
            <div class="header-wrapper row m-0">
                ...
                <div class="header-logo-wrapper col-auto p-0">
                    <div class="logo-wrapper"><a href="<?= BASE_URL; ?>/dosen"><img class="img-fluid"
                        ...
                        <li class="profile-nav onhover-dropdown pe-0 py-0">
                            <div class="media profile-media">
                                <div class="media-body"><span><?=$_SESSION['namauser_member'];?></span>
                                    <p class=" mb-0">akun <i class="middle fa fa-angle-down"></i></p>
                                </div>
                            </div>
                            <ul class="profile-dropdown onhover-show-div">
                                <li><a href="<?= BASE_URL ?>/dosen/profile"><i data-feather="user"></i><span>Profil
                                        </span></a></li>
        ...
        <div class="page-body-wrapper">
            ...
            <div class="sidebar-wrapper" sidebar-layout="stroke-svg">
                <div>
                    <div class="logo-wrapper"><a href="<?= BASE_URL ?>/dosen">
                    ...
                    <div class="logo-icon-wrapper"><a href="<?= BASE_URL; ?>/dosen"><img class="img-fluid"
                    ...
                    <nav class="sidebar-main">
                        ...
                        <div id="sidebar-menu">
                            <ul class="sidebar-links" id="simple-bar">
                                <li class="back-btn">
                                    <a href="<?= BASE_URL; ?>/dosen"><img class="img-fluid"
                                            src="<?= BASE_URL . '/' . DIR_INC; ?>/images/logombkm.png" alt=""></a>
                                ...
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="<?= BASE_URL; ?>/dosen/kelas">
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= BASE_URL . '/' . DIR_INC; ?>/svg/icon-sprite.svg#stroke-learning">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use
                                                href="<?= BASE_URL . '/' . DIR_INC; ?>/svg/icon-sprite.svg#fill-learning">
                                            </use>
                                        </svg><span>Kelas DPL</span></a>
                                </li>
                                <li class="sidebar-main-title">
                                    <div>
                                        <h6>Assesment</h6>
                                ...
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="<?= BASE_URL; ?>/dosen/laporanakhir">
                                        <svg class="stroke-icon">
                                            <use
                ...
                <div class="mb-middle">
                    ...
                    <div class="mb-footer">
                        <div class="pull-right">
                            <a href="<?= BASE_URL; ?>/dosen/logout" class="btn btn-success btn-lg">Ya</a>
        ...
        <script src="<?= BASE_URL . '/' . DIR_INC; ?>/akun/js/tooltip-init.js"></script>
        <script src="<?= BASE_URL . '/' . DIR_INC; ?>/akun/js/slick/slick.min.js"></script>
        <script src="<?= BASE_URL . '/' . DIR_INC; ?>/akun/js/slick/slick.js"></script>
        <script src="<?= BASE_URL . '/' . DIR_INC; ?>/akun/js/header-slick.js"></script>
        <script src="<?= BASE_URL . '/' . DIR_INC; ?>/akun/js/photoswipe/photoswipe.min.js"></script>
        <script src="<?= BASE_URL . '/' . DIR_INC; ?>/akun/js/photoswipe/photoswipe-ui-default.min.js"></script>
        <script src="<?= BASE_URL . '/' . DIR_INC; ?>/akun/js/photoswipe/photoswipe.js"></script>
        <script src="<?= BASE_URL . '/' . DIR_INC; ?>/akun/js/sweet-alert/sweetalert.min.js"></script>
        <script src="<?= BASE_URL . '/' . DIR_INC; ?>/akun/js/chart/apex-chart/apex-chart.js"></script>
        <script src="<?= BASE_URL . '/' . DIR_INC; ?>/akun/js/height-equal.js"></script>
        <script src="<?= BASE_URL . '/' . DIR_INC; ?>/akun/js/validate/jquery.validate.min.js"></script>
        <!-- Plugins JS Ends-->
        ...
        <script>
        document.querySelector("div.dataTables_wrapper div.toolbar").innerHTML =
            "<span class='btn btn-warning text-dark'>Periode Akademik: <?=$this->pocore()->call->Convert_periode_totext($this->e($tahun_akademik));?></span>";
        </script>
        <?php } ?>
