...
$mbkm_dpl = $this->pocore()->call->podb->from('mbkm_dpl_kelas_peserta')
                                       ->select('mbkm_dpl_kelas.kode_dosen')
                                       ->leftJoin('mbkm_dpl_kelas ON mbkm_dpl_kelas.id=mbkm_dpl_kelas_peserta.id_kelas_dpl')
                                       ->where('mbkm_dpl_kelas_peserta.nim', $current_akun['nim'])
                                       ->where('mbkm_dpl_kelas_peserta.periode_krs', $this->e($tahun_akademik))
                                       ->limit(1)
                                       ->fetch(); 
$dosen = $this->pocore()->call->podb->from('dosen')->where('kode_nama', $mbkm_dpl['kode_dosen'])->limit(1)->fetch(); 
?>
<style>
.center-image {
    display: block;
...
<div class="page-body">
                        ...
                        <div class="card-body" style="padding: 10px 30px;">
                            <div class="media media-wrapper justify-content-between">
                                <div class="media-body">
                                    <div class="greeting-user" style="width: 100% !important;">
                                        <h4 class="f-w-600"><?=$mbkm_kat['mbkm_kategori_nama']?>
                                        </h4>
                                        <p style="width: 100% !important;">
                                            <?php 
                                            if(empty($mbkm_bkp['mbkm_jenis_nama'])){
                                                echo '-';
                                            }else{
                                                echo strtoupper($mbkm_bkp['mbkm_jenis_nama']);
                                            }
                                            ?>
                                        </p>
                                    </div>
                            ...
                            <div class="media media-wrapper justify-content-between">
                                <div class="media-body">
                                    <div class="greeting-user">
                                        <h4 class="f-w-600">DPL</h4>
                                        <p style="width: 100% !important;">
                                            <?php 
                                            if(empty($dosen['nama'])){
                                                echo '-';
                                            }else{
                                                echo strtoupper($dosen['nama']);
                                            }
                                            ?>
                                        </p>
                                    </div>
                    ...
                    <div class="card profile-box">
                        <div class="card-body" style="padding: 10px 30px;">
                            <div class="media media-wrapper justify-content-between">
                                <div class="media-body">
                                    <div class="greeting-user">
                                        <h4 class="f-w-600">Lokasi</h4>
                                        <p style="width: 100% !important;">
                                            <?php 
                                            if(empty($current_akun['lokasi_kegiatan'])){
                                                echo '-';
                                            }else{
                                                echo strtoupper($current_akun['lokasi_kegiatan']);
                                            }
                                            ?>
                                    </div>
                                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="<?=BASE_URL;?>/mahasiswa/logbook/add"
                                ...
                                <div class="form theme-form">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control digits" type="date" name="tanggal_kegiatan"
                                                    id="tanggal" placeholder="Hari-Bulan-Tahun (DD-MM-YYYY)" required>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="time" name="jam_awal"
                                                    id="twenty-four-hour" placeholder="Jam:Menit (hh:mm)" required>
                                                <div class="invalid-tooltip">Harus diisi.</div>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control digits" type="time" name="jam_akhir"
                                                    id="twenty-four-hour" placeholder="hh:mm" required>
                                                <div class="invalid-tooltip">Harus diisi.</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="alert alert-light-dark light alert-dismissible fade show text-dark border-left-wrapper"
                                        ...
                                        <p>
                                            ...
                                            2. Klik icon &#8634; untuk mereset foto
                                        </p>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="center-image">
                                                <div class="form-input-image">
                                                    ...
                                                    <input type="file" name="img_two" id="file-ip-2" accept="image/*"
                                                        onchange="showPreview(event, 2);" required>
                                                    <div class="invalid-tooltip">Harus diisi.</div>
                                                </div>
                                            ...
                                            <div class="center-image">
                                                <div class="form-input-image">
                                                    ...
                                                    <input type="file" name="img_three" id="file-ip-3" accept="image/*"
                                                        onchange="showPreview(event, 3);" required>
                                                    <div class="invalid-tooltip">Harus diisi.</div>
                                                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="text-center"><button type="submit" class="btn btn-success me-3 simpan"
                                            id="btnSimpan">Simpan</button><a class="btn btn-danger"
    ...
    window.addEventListener("DOMContentLoaded", function(e) {
        $("#formInput").submit(function(e) {
            ...
            $("#btnSimpan").html(
                '<i class="fa fa-spin fa-spinner mr-2"></i> Proses Simpan'
            );
        });
        ...
        $(document).on("input", "textarea[word-limit=true]", function() {
            ...
            if (wordCount < thisMin) {
                $(this)
                    .parent()
                    .children(".words")
                    .text(wordCount + " kata terinput");
                $(this)
                    .parent()
                    .children(".writing_error")
                    .text("Silahkan input kegiatan minimal " + thisMin + ".");
                // $(this).parent().children("textarea.form-control").addClass('is-invalid');
                $(this).parent().children("textarea.form-control").addClass("is-invalid");
                $(this)
                    .parent()
                    .children("textarea.form-control")
                ...
                $(this)
                    .parent()
                    .children(".writing_error")
                    .text("Silahkan input kegiatan maksimal " + thisMax + ".");
