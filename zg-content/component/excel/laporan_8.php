...
<div class="row" style="padding: 20px;">
    <div class="col-md-12">
        ...
        <div class="table-responsive">
            <h4 style="width: 100%; text-align: center; font-weight: bold; line-height: 1px; padding: 10px;">LAPORAN DATA BELUM BAYAR REGISTRASI FORMULIR</h4>
            ...
            <table id="tabelExport" class="table table-bordered table-hover">
                <thead style="width: 100%; ">
                    ...
                    <tr>
                        ...
                        <th class="text-center"><strong>NO.TELEPON/HP</strong></th>
                ...
                <tbody>
                    ...
                    $no = 1;
                    if ($_POST['prodi'] == 'all') {
                        $dataPeserta = $laporan->podb->from('peserta')->where('tahun_ajaran', $_POST['tahunajaran'])->where('block', 'Y')->orderBy('tgl_daftar ASC');
                    } else {
                        $dataPeserta = $laporan->podb->from('peserta')->where('pilihan_pertama', $_POST['prodi'])->where('tahun_ajaran', $_POST['tahunajaran'])->where('block', 'Y')->orderBy('tgl_daftar ASC');
                    }
