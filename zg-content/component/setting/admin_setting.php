        ...
        <div class="col-md-12">
            <ul class="nav nav-tabs nav-justified" role="tablist">
                <li role="presentation" class="active"><a href="#general" aria-controls="general" role="tab"
                        data-toggle="tab" style="color:#3498DB !important;"><i
                            class="fa fa-desktop"></i>&nbsp;&nbsp;<?=$GLOBALS['_']['setting_general'];?></a></li>
                <li role="presentation"><a href="#image" aria-controls="image" role="tab" data-toggle="tab"
                        style="color:#E74C3C !important;"><i
                            class="fa fa-image"></i>&nbsp;&nbsp;<?=$GLOBALS['_']['setting_image'];?></a></li>
                <li role="presentation"><a href="#local" aria-controls="local" role="tab" data-toggle="tab"
                        style="color:#18BC9C !important;"><i
                            class="fa fa-globe"></i>&nbsp;&nbsp;<?=$GLOBALS['_']['setting_local'];?></a></li>
                <li role="presentation"><a href="#config" aria-controls="config" role="tab" data-toggle="tab"
                        style="color:#F39C12 !important;"><i
                            class="fa fa-gears"></i>&nbsp;&nbsp;<?=$GLOBALS['_']['setting_config'];?></a></li>
                <li role="presentation"><a href="#oauth" aria-controls="oauth" role="tab" data-toggle="tab"
                        style="color:#16a085 !important;"><i
                            class="fa fa-share"></i>&nbsp;&nbsp;<?=$GLOBALS['_']['setting_oauth'];?></a></li>
            </ul>
            <div class="tab-content">
                        ...
                        <table class="table table-striped table-hover table-setting">
                            <tr>
                                ...
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="web_name" data-type="text" data-pk="1"
                                        data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[0]['value'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_web_url'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="web_url" data-type="text" data-pk="2"
                                        data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[1]['value'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_web_meta'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="web_meta" data-type="textarea" data-rows="3"
                                        data-pk="3" data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[2]['value'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_web_keyword'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="web_keyword" data-type="textarea" data-rows="3"
                                        data-pk="4" data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[3]['value'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_web_owner'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="web_owner" data-type="text" data-pk="5"
                                        data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[4]['value'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_email'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="email" data-type="email" data-pk="6"
                                        data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[5]['value'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_telephone'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="telephone" data-type="text" data-pk="7"
                                        data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[6]['value'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_fax'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="fax" data-type="text" data-pk="8"
                                        data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[7]['value'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_address'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="address" data-type="textarea" data-rows="3"
                                        data-pk="9" data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[8]['value'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_geocode'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="geocode" data-type="textarea" data-pk="10"
                                        data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[9]['value'];?></a>
                                </td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table class="table table-striped table-hover table-setting">
                            <tr>
                                ...
                                <td class="link-setting">
                                    ...
                                    <img src="../<?=DIR_INC;?>/images/favicon.png" class="thumbnail img-responsive"
                                        width="32" />
                                    <?php } ?>
                                    ...
                                    <div class="input-group col-md-5">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-sm btn-primary" type="submit"><i
                                                    class="fa fa-check"></i> <?=$GLOBALS['_']['action_5'];?></button>
                                        </span>
                                    </div>
                                    <?=$this->pohtml->formEnd();?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="link-setting">
                                    ...
                                    <img src="../<?=DIR_INC;?>/images/logo.png" class="thumbnail img-responsive"
                                        width="100" />
                                    <?php } ?>
                            ...
                            <tr>
                                ...
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="img_medium" data-type="text" data-pk="13"
                                        data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[12]['value'];?></a>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane" id="local">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-setting">
                            <tr>
                                ...
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="country" data-type="select" data-pk="14"
                                        data-url="route.php?mod=setting&act=edit"
                                        data-value="<?=$settings[13]['value'];?>"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[13]['value'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_region_state'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="region_state" data-type="select" data-pk="15"
                                        data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[14]['value'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_timezone'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="timezone" data-type="select" data-pk="16"
                                        data-url="route.php?mod=setting&act=edit"
                                        data-value="<?=$settings[15]['value'];?>"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[15]['value'];?></a>
                                        ...
                                        <div class="col-table col-md-3">
                                            ...
                                            <select class="form-control input-sm" name="language" onChange="submit()">
                                                <?php
															...
															?>
                                                <option value="<?=$lang['code'];?>" <?=$langselopt;?>>
                                                    <?=$lang['title'];?></option>
                                                <?php } ?>
                                            </select>
                                            <?=$this->pohtml->formEnd();?>
                    ...
                    <div class="row" style="padding:10px;">
                        <div class="col-md-12" style="margin-bottom:10px;">
                            ...
                            <div class="pull-right"><a href="admin.php?mod=setting&act=addnewlang"
                                    class="btn btn-sm btn-success"><i class="fa fa-plus"></i>
                                    <?=$GLOBALS['_']['addnew'];?></a></div>
                        </div>
                        <div class="col-md-12">
                ...
                <div role="tabpanel" class="tab-pane" id="config">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-setting">
                            <tr>
                                ...
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="maintenance" data-type="select" data-pk="17"
                                        data-url="route.php?mod=setting&act=edit"
                                        data-value="<?=$settings[16]['value'];?>"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[16]['value'];?></a>
                                </td>
                            </tr>

                            <tr>
                                <td style="width:265px;">Durasi Jam MBKM</td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="comment" data-type="select" data-pk="19"
                                        data-url="route.php?mod=setting&act=edit"
                                        data-value="<?=$settings[18]['value'];?>"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[18]['value'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_item_per_page'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="item_per_page" data-type="number" data-pk="20"
                                        data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[19]['value'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_google_analytics'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="google_analytics" data-type="text" data-pk="21"
                                        data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[20]['value'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_recaptcha_sitekey'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="recaptcha_sitekey" data-type="text" data-pk="22"
                                        data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[21]['value'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_recaptcha_secretkey'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="recaptcha_secretkey" data-type="text" data-pk="23"
                                        data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[22]['value'];?></a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon" style="padding:5px 15px;">
                                                <?=$GLOBALS['_']['setting_sitemap_change'];?></div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon" style="padding:5px 15px;">
                                                <?=$GLOBALS['_']['setting_sitemap_priority'];?></div>
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-sm btn-primary"
                                            type="submit"><?=$GLOBALS['_']['setting_sitemap_btn'];?></button>
                                    </div>
                                    <?=$this->pohtml->formEnd();?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="permalink" data-type="select" data-pk="29"
                                        data-url="route.php?mod=setting&act=edit"
                                        data-value="<?=(!empty($settings[28]['value']) ? $settings[28]['value'] : 'slug/post-title');?>"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=(!empty($settings[28]['value']) ? $settings[28]['value'] : 'slug/post-title');?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_slug_permalink'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="slug_permalink" data-type="text" data-pk="30"
                                        data-url="route.php?mod=setting&act=edit"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=(!empty($settings[29]['value']) ? $settings[29]['value'] : 'detailpost');?></a>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="row" style="padding:10px;">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" id="pocodemirror" name="meta_content"
                                style="width:100%; height:300px;"><?=$data_meta;?></textarea>
                            <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-check"></i>
                                <?=$GLOBALS['_']['action_5'];?></button>
                            <?=$this->pohtml->formEnd();?>
                            <?php } ?>
                        </div>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane" id="oauth">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-setting">
                            <tr>
                                ...
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="oauth_fb_app_id" data-type="text" data-pk="1"
                                        data-url="route.php?mod=setting&act=editoauth&key=oauth_key"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$oauths[0]['oauth_key'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_oauth_fb_app_secret'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="oauth_fb_app_secret" data-type="text" data-pk="1"
                                        data-url="route.php?mod=setting&act=editoauth&key=oauth_secret"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$oauths[0]['oauth_secret'];?></a>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <a href="../<?=DIR_CON;?>/component/oauth/facebook/index.php"
                        class="btn btn-sm btn-primary"><?=$GLOBALS['_']['setting_oauth_create'];?></a>
                    <a href="route.php?mod=setting&act=deleteoauth&id=1"
                        class="btn btn-sm btn-danger"><?=$GLOBALS['_']['setting_oauth_delete'];?></a>
                    <div class="help-block"><span class="text-danger">*)</span>
                        <?=$GLOBALS['_']['setting_oauth_help_1'];?></div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-setting">
                            <tr>
                                ...
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="oauth_tw_consumer_key" data-type="text" data-pk="2"
                                        data-url="route.php?mod=setting&act=editoauth&key=oauth_key"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$oauths[1]['oauth_key'];?></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:265px;"><?=$GLOBALS['_']['setting_oauth_tw_consumer_secret'];?></td>
                                <td class="link-setting">
                                    <a href="javascript:void(0)" id="oauth_tw_consumer_secret" data-type="text"
                                        data-pk="2" data-url="route.php?mod=setting&act=editoauth&key=oauth_secret"
                                        title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$oauths[1]['oauth_secret'];?></a>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <a href="../<?=DIR_CON;?>/component/oauth/twitter/index.php"
                        class="btn btn-sm btn-primary"><?=$GLOBALS['_']['setting_oauth_create'];?></a>
                    <a href="route.php?mod=setting&act=deleteoauth&id=2"
                        class="btn btn-sm btn-danger"><?=$GLOBALS['_']['setting_oauth_delete'];?></a>
                    <div class="help-block"><span class="text-danger">*)</span>
                        <?=$GLOBALS['_']['setting_oauth_help_2'];?></div>
                </div>
            </div>
        </div>
    </div>
