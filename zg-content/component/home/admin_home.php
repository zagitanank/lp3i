...
<div class="row">
    <div class="col-md-10">
        <div class="widget">
            <div class="mini-stats">
                ...
                <h3 style="text-align:left;"><?= $GLOBALS['_']['home_welcome']; ?> SIM MBKM</h3>
            </div>
        </div>
    </div>
    <div class="col-md-2">
        <div class="widget ">
            <div class="mini-stats">
                <p style="text-align:left;">Periode Akademik:</p>
                <h3 style="text-align:left;">
                    <?= $this->Convert_periode_totext($this->mbkmsetting['mbkm_jadwal_periode']); ?></h3>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="widget">
            <div class="mini-stats">
                <a href="admin.php?mod=peserta"><span class="bg-primary"><i class="fa fa-graduation-cap"></i></span></a>
                <p>Jumlah Pendaftar</p>
                <h3><?= $this->podb->from('mbkm_peserta')
								->where('periode', $this->mbkmsetting['mbkm_jadwal_periode'])
								->count();
							?>
    ...
    <div class="col-md-3">
        <div class="widget">
            <div class="mini-stats">
                <a href="#"><span class="bg-primary"><i class="fa fa-tasks"></i></span></a>
                <p>Prodi Pendaftar</p>
                <h3><?= $this->podb->from('mbkm_peserta')->where('periode', $this->mbkmsetting['mbkm_jadwal_periode'])->groupBy('kode_prodi')->count(); ?>
                </h3>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="widget">
            <div class="mini-stats">
                <a href="#"><span class="bg-primary"><i class="fa fa-tags"></i></span></a>
                <p>BKP Pendaftar</p>
                <h3><?= $this->podb->from('mbkm_peserta')->where('periode', $this->mbkmsetting['mbkm_jadwal_periode'])->groupBy('jenis_mbkm')->count(); ?>
                </h3>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="widget">
            <div class="mini-stats">
                <a href="admin.php?mod=dpl"><span class="bg-primary"><i class="fa fa-briefcase"></i></span></a>
                <p>DPL</p>
                <h3><?= $this->podb->from('mbkm_dpl')
								->where('periode', $this->mbkmsetting['mbkm_jadwal_periode'])
								->where('status_seleksi', '1')
								->count();
							?>
    ...
    <div class="col-md-3">
        <div class="widget">
            <div class="mini-stats">
                <a href="#"><span class="bg-success"><i class="fa fa-check-square"></i></span></a>
                <p>Lulus Seleksi</p>
                <h3><?= $this->podb->from('mbkmp_peserta')
								->where('periode', $this->mbkmsetting['mbkm_jadwal_periode'])
								->where('status_seleksi', '1')
								->count();
							?>
    ...
    <div class="col-md-3">
        <div class="widget">
            <div class="mini-stats">
                <a href="#"><span class="bg-danger"><i class="fa fa-exclamation-triangle"></i></span></a>
                <p>Tidak Lulus Seleksi</p>
                <h3><?= $this->podb->from('mbkmp_peserta')
								->where('periode', $this->mbkmsetting['mbkm_jadwal_periode'])
								->where('status_seleksi', '2')
								->count();
							?>
                </h3>
            </div>
    ...
    <div class="col-md-3">
        <div class="widget">
            <div class="mini-stats">
                <a href="admin.php?mod=user"><span class="bg-warning"><i class="fa fa-group"></i></span></a>
                <p><?= $GLOBALS['_']['user']; ?></p>
                ...
                <div class="media">
                    ...
                    <div class="media-left">
                        <a href="<?= $this->postring->permalink(rtrim(WEB_URL, '/'), $post_pop); ?>" target="_blank">
                            <img class="media-object" src="../zg-content/thumbs/<?= $post_pop['picture']; ?>"
                                width="64" />
                        </a>
                    </div>
                    <?php } ?>
                    <div class="media-body">
                        <span><?= date('d M Y', strtotime($post_pop['date'])); ?> -
                            <?= $GLOBALS['_']['home_popular_view']; ?> <?= $post_pop['hits']; ?>
                            <?= $GLOBALS['_']['home_popular_times']; ?></span>
                        <a href="<?= $this->postring->permalink(rtrim(WEB_URL, '/'), $post_pop); ?>"
                            target="_blank"><?= $post_pop['title']; ?></a>
                    </div>
                </div>
                <?php } ?>
            </div>
                ...
                <div class="pull-right text-right" style="margin-top:-60px;">
                    <form class="form-inline" action="admin.php?mod=home" method="post">
                        <select class="form-control input-sm" name="showchart" onChange="submit()">
                            <option value="chartweek" <?= ($pilchart == 'chartweek' ? 'selected' : ''); ?>>
                                <?= $GLOBALS['_']['home_statsweek']; ?></option>
                            <option value="chartmonth" <?= ($pilchart == 'chartmonth' ? 'selected' : ''); ?>>
                                <?= $GLOBALS['_']['home_statsmonth']; ?></option>
                            <option value="chartyear" <?= ($pilchart == 'chartyear' ? 'selected' : ''); ?>>
                                <?= $GLOBALS['_']['home_statsyear']; ?></option>
                        </select>
...
<div class="block-content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <script type="text/javascript">
            var datastats = {
                labels: ["<?= date('d M', strtotime('-6 days')); ?>", "<?= date('d M', strtotime('-5 days')); ?>",
                    "<?= date('d M', strtotime('-4 days')); ?>", "<?= date('d M', strtotime('-3 days')); ?>",
                    "<?= date('d M', strtotime('-2 days')); ?>", "<?= date('d M', strtotime('-1 days')); ?>",
        ...
        <div class="col-md-4 col-sm-4">
            <div class="widget">
                <div class="mini-stats">
                    ...
                    <h3><?= $this->podb->from('traffic')->where('date', date('Y-m-d'))->where('online > "' . $todaytime . '"')->count(); ?>
                    </h3>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover">
                    <tr>
                        <th colspan="7" class="text-center text-uppercase"><?= $GLOBALS['_']['home_top_visitor']; ?>
                        </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?= ($visitor['browser'] == '' ? $GLOBALS['_']['home_others'] : $visitor['browser']); ?>
                        </td>
                        <td class="text-center">
                            <?= ($visitor['platform'] == '' ? $GLOBALS['_']['home_others'] : $visitor['platform']); ?>
                        </td>
                        <td class="text-center">
                            <?= ($visitor['country'] == '' ? $GLOBALS['_']['home_no_country'] : $visitor['country']); ?>
                        </td>
                        <td class="text-center">
                            <?= ($visitor['city'] == '' ? $GLOBALS['_']['home_no_city'] : $visitor['city']); ?></td>
    ...
    <div class="row">
        <div class="col-md-6 col-sm-6">
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover">
                    <tr>
                        <th colspan="3" class="text-center text-uppercase"><?= $GLOBALS['_']['home_top_browser']; ?>
                        </th>
                    </tr>
                    <tr>
                        <th class="text-center"><?= $GLOBALS['_']['home_number']; ?></th>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?= ($browser['browser'] == '' ? $GLOBALS['_']['home_others'] : $browser['browser']); ?>
                        </td>
                        <td class="text-center"><span class="label label-success"><?= $browser['hitstoday']; ?></span>
                        </td>
                    </tr>
                    <?php $nobrowser++;
							} ?>
        ...
        <div class="col-md-6 col-sm-6">
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover">
                    <tr>
                        <th colspan="3" class="text-center text-uppercase"><?= $GLOBALS['_']['home_top_platform']; ?>
                        </th>
                    </tr>
                    <tr>
                        <th class="text-center"><?= $GLOBALS['_']['home_number']; ?></th>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?= ($platform['platform'] == '' ? $GLOBALS['_']['home_others'] : $platform['platform']); ?>
                        </td>
                        <td class="text-center"><span class="label label-danger"><?= $platform['hitstoday']; ?></span>
                        </td>
                    </tr>
                    <?php $noplatform++;
							} ?>
    ...
    <div class="row">
        <div class="col-md-6 col-sm-6">
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover">
                    <tr>
                        <th colspan="3" class="text-center text-uppercase"><?= $GLOBALS['_']['home_top_country']; ?>
                        </th>
                    </tr>
                    <tr>
                        <th class="text-center"><?= $GLOBALS['_']['home_number']; ?></th>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?= ($country['country'] == '' ? $GLOBALS['_']['home_no_country'] : $country['country']); ?>
                        </td>
                        <td class="text-center"><span class="label label-warning"><?= $country['hitstoday']; ?></span>
                        </td>
                    </tr>
                    <?php $nocountry++;
							} ?>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?= ($city['city'] == '' ? $GLOBALS['_']['home_no_city'] : $city['city']); ?></td>
