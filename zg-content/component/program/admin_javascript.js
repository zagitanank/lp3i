 ...
 * This is a main javascript file from Zagitanank which contains all javascript in program.
 *
*/

$(document).ready(function() {
	$('#table-program').buildtable('route.php?mod=program&act=datatable');
});
...
$(document).ready(function() {
	...
	$('.btn-del-image').click(function () {
		...
		$.ajax({
			type: "POST",
			url: "route.php?mod=program&act=delimage",
			data: dataString,
			cache: false,
