 ...
 * This is a main javascript file from Zagitanank which contains all javascript in jadwal.
 *
*/

$(document).ready(function() {
	$('#table-jadwal').buildtable('route.php?mod=jadwal&act=datatable');
});
...
$(document).ready(function() {
	...
	$('.btn-del-image').click(function () {
		...
		$.ajax({
			type: "POST",
			url: "route.php?mod=jadwal&act=delimage",
			data: dataString,
			cache: false,
