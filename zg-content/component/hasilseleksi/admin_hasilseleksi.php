...
class hasilseleksi extends PoCore
{
    ...
    {
        if (!$this->auth($_SESSION['leveluser'], 'hasilseleksi', 'read')) {
        ...
        <div class="block-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <?php
                    $columns = array(
                        array('title' => 'No Peserta', 'options' => 'style="width:80px;"'),
                        array('title' => 'Nama Lengkap', 'options' => ''),
                        array('title' => 'Jalur', 'options' => ''),
                        array('title' => 'Gel', 'options' => ''),
                        array('title' => 'TA', 'options' => ''),
                        array('title' => 'Status', 'options' => ''),
                        array('title' => 'Tindakan', 'options' => 'class="no-sort" style="width:150px;"')
                    );
                    ?>
                    <?= $this->pohtml->createTableNoDelete(array('id' => 'table-hasilseleksi', 'class' => 'table table-striped table-bordered'), $columns, $tfoot = false); ?>

                </div>
            </div>
        </div>
        <?= $this->pohtml->dialogAktifasi('hasilseleksi'); ?>
        <?= $this->pohtml->dialogVerifikasi('hasilseleksi'); ?>
    <?php
    }
                ...
                'formatter' => function ($d, $row, $i) {
                    if ($_SESSION['leveluser'] == '9') {
                        $tombolaksi = "
                            ...
                            <a href='admin.php?mod=hasilseleksi&act=edit&id=" . $row['id_session'] . "' class='btn btn-xs btn-default' data-toggle='tooltip' title='Detail'><i class='fa fa-pencil'></i></a>
						    <a href='admin.php?mod=hasilseleksi&act=gantipassword&id=" . $row['id_session'] . "' class='btn btn-xs btn-default' style='background:#2D1780; border-color:#2D1780;' data-toggle='tooltip' title='Ganti Password'><i class='fa fa-key'></i></a>
                            ";
                    } else {
                        $tombolaksi = "
                            <a href='admin.php?mod=hasilseleksi&act=hasilseleksi&id=" . $row['id_session'] . "' class='btn btn-xs btn-warning' data-toggle='tooltip' title='Penentuan Seleksi'><i class='fa fa-bullhorn'></i></a>
                            <a href='admin.php?mod=hasilseleksi&act=edit&id=" . $row['id_session'] . "' class='btn btn-xs btn-default' data-toggle='tooltip' title='Detail'><i class='fa fa-pencil'></i></a>
						    <a href='admin.php?mod=hasilseleksi&act=gantipassword&id=" . $row['id_session'] . "' class='btn btn-xs btn-default' style='background:#2D1780; border-color:#2D1780;' data-toggle='tooltip' title='Ganti Password'><i class='fa fa-key'></i></a>
                            ";
                    }
    ...
    {
        if (!$this->auth($_SESSION['leveluser'], 'hasilseleksi', 'update')) {
            echo $this->pohtml->error();
            exit;
        }
        if (!empty($_POST)) {
            ...
            $this->poflash->success('Konfirmasi bayar daftar ulang telah berhasil', 'admin.php?mod=hasilseleksi');
        }
    }
    ...
    public function edit()
    {
        ...
        if (!empty($_POST)) {
            ...
            if ($validated_data === false) {
                $this->poflash->error($GLOBALS['_']['hasilseleksi_message_5'], 'admin.php?mod=hasilseleksi&act=edit&id=' . $this->postring->valid($_POST['id'], 'xss'));
            } else {
                ...
                $this->poflash->success($GLOBALS['_']['hasilseleksi_message_2'], 'admin.php?mod=hasilseleksi');
            }
        }
    ...
    ?>
        <div class="block-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <?= $this->pohtml->formStart(array('method' => 'post', 'action' => 'route.php?mod=hasilseleksi&act=edit&id=' . $current_user['id_session'], 'enctype' => true, 'autocomplete' => 'off')); ?>
    ...
    public function gantipassword()
    {
        ...
        if (!empty($_POST)) {
            ...
            $this->poflash->success('Berhasil! Ganti Password', 'admin.php?mod=hasilseleksi');
        }
        $id = $this->postring->valid($_GET['id'], 'xss');
    ...
    ?>
        ...
        <div class="block-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form role="form" method="post" id="passwordForm" action="route.php?mod=hasilseleksi&act=gantipassword" autocomplete="off">
    ...
    public function nilairaport()
    {
        ...
        if (!empty($_POST)) {
            ...
            $this->poflash->success('Berhasil! Mengubah data Nilai Raport', 'admin.php?mod=hasilseleksi');
        }
        $id = $this->postring->valid($_GET['id'], 'xss');
        $current_peserta = $this->podb->from('peserta')
            ->where('id_session', $id)
    ...
    ?>
        <div class="block-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form role="form" method="post" action="route.php?mod=hasilseleksi&act=raport" autocomplete="off">
                        <?= $this->pohtml->inputHidden(array('name' => 'id', 'value' => $current_peserta['id_peserta'])); ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
    ...
    ?>
        <div class="block-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <?= $this->pohtml->formStart(array('method' => 'post', 'action' => 'route.php?mod=hasilseleksi&act=nilai&id=' . $current_user['id_session'], 'enctype' => true, 'autocomplete' => 'off')); ?>
                    <?= $this->pohtml->inputHidden(array('name' => 'id', 'value' => $current_user['id_session'])); ?>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
    ...
    public function hasilseleksi()
    {
        ...
        if (!empty($_POST)) {
            ...
            $this->poflash->success('Berhasil! Hasil seleksi masuk telah ditentukan', 'admin.php?mod=hasilseleksi');
        }
        $id = $this->postring->valid($_GET['id'], 'xss');
        $current_peserta = $this->podb->from('peserta')
            ->where('id_session', $id)
    ...
    ?>
        ...
        <div class="block-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form role="form" method="post" action="route.php?mod=hasilseleksi&act=hasilseleksi" autocomplete="off">
                        <?= $this->pohtml->inputHidden(array('name' => 'id', 'value' => $current_peserta['id_peserta'])); ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
...
<?php
    ...
    {
        if (!$this->auth($_SESSION['leveluser'], 'hasilseleksi', 'delete')) {
            echo $this->pohtml->error();
            exit;
        }
        if (!empty($_POST)) {
            $query = $this->podb->deleteFrom('hasilseleksi')->where('id_session', $this->postring->valid($_POST['id'], 'xss'));
            $query->execute();
            $this->poflash->success('Peserta has been successfully deleted', 'admin.php?mod=hasilseleksi');
        }
    }
    ...
    public function multidelete()
    {
        ...
        if (!empty($_POST)) {
            ...
            if ($totaldata != "0") {
                ...
                $this->poflash->error('Error deleted peserta data', 'admin.php?mod=hasilseleksi');
            }
        }
    }
