 ...
 *
 *
 * Ini adalah file utama javascript Zagitanank yang memuat semua javascript di hasilseleksi.
 * This is a main javascript file from Zagitanank which contains all javascript in hasilseleksi.
 *
*/
...
$("#kotasekolah").change(function() { // Ketika user mengganti atau memilih data utama
            ...
            $.ajax({
                ...
                url: 'route.php?mod=hasilseleksi&act=smta', // Isi dengan url/path file php yang dituju
                data: {
...
$('#jenjang').change(function() {
    ...
    if (jenjang) {
        $.ajax({
            type: 'POST',
            url: 'route.php?mod=hasilseleksi&act=prodi',
...
$(document).ready(function() {
	...
	var table = $('#table-hasilseleksi').DataTable({
		"autoWidth": false,
		"responsive": true,
		"order": [[1, 'desc']],
		"columnDefs": [{
		...
		"ajax": {
			'type': 'post',
			'url': 'route.php?mod=hasilseleksi&act=datatable'
		},
