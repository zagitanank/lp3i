 ...
 * This is a main javascript file from Zagitanank which contains all javascript in layanan.
 *
*/

$(document).ready(function() {
	$('#table-layanan').buildtable('route.php?mod=layanan&act=datatable');
});
...
$(document).ready(function() {
	...
	$('.btn-del-image').click(function () {
		...
		$.ajax({
			type: "POST",
			url: "route.php?mod=layanan&act=delimage",
			data: dataString,
			cache: false,
