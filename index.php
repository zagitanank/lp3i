...
if (file_exists('install.php')) {
	...
	if (strpos($_SERVER['REQUEST_URI'], DIR_ADM) !== false) {
		 ...
		 *
		 */
		if (strpos($_SERVER['REQUEST_URI'], 'akun') !== false) {
			$active_template = "/akun";
		}elseif (strpos($_SERVER['REQUEST_URI'], 'mahasiswa') !== false) {
			$active_template = "/mahasiswa";
		}elseif (strpos($_SERVER['REQUEST_URI'], 'dosen') !== false) {
			$active_template = "/dosen";
		} else {
