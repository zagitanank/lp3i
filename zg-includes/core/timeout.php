...
class PoTimeout
{
	...
	public function rec_session_dosen($session = array())
	{
		$_SESSION['iduser_member'] = $session['id'];
		$_SESSION['namauser_member'] = $session['kode_nama'];
		$_SESSION['namalengkap_member'] = $session['nama'];
		$_SESSION['passuser_member'] = $session['pwd'];
		$_SESSION['leveluser_member'] = '2';
		$_SESSION['login_member'] = 1;
	}

	public function rec_session_mahasiswa($session = array())
	{
		$_SESSION['iduser_member'] = $session['id'];
		$_SESSION['namauser_member'] = $session['nim'];
		$_SESSION['namalengkap_member'] = $session['nama'];
		$_SESSION['passuser_member'] = $session['pwd'];
		$_SESSION['leveluser_member'] = '5';
		$_SESSION['login_member'] = 1;
	}
