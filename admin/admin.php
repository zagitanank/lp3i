...
<head>
    ...
    <meta name="author" content="lp3imks" />
    ...
    <title>
        <?php $titcomponame = ucfirst($_GET['mod']); if ($_SESSION['leveluser']=='1' OR $_SESSION['leveluser']=='2'){ echo $titcomponame; ?>
        - Administrator Dashboard<?php }else{ echo $titcomponame; ?> - Member Dashboard<?php } ?></title>
    ...
    <?php if ($_GET['mod'] == "survey" && $_GET['act'] == 'statistik')  { ?>
    <style>
...
<body class="fixed-left">
                        ...
                        <ul class="nav navbar-nav navbar-right pull-right">
                            ...
                            <li class="dropdown" style="float:left;">
                                <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true">
									...
									?>
                                    <img src="../<?=DIR_CON;?>/uploads/user-<?=$avatarimg;?>.jpg"
                                        alt="<?=$_SESSION['namauser'];?>" width="30" height="30" class="img-circle"
                                        title="<?=$_['quickaccess'];?>" />
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a href="<?=WEB_URL;?>" target="_blank"><i
                                                class="fa fa-desktop"></i>&nbsp;&nbsp;<?=$_['tofrontend'];?></a></li>
                                    <li><a href="admin.php?mod=contact"><i
                                                class="fa fa-envelope"></i>&nbsp;&nbsp;<?=$_['message'];?></a></li>
                                    <li class="divider visible-lg"></li>
                                    <li><a href="admin.php?mod=user"><i
                                                class="fa fa-user"></i>&nbsp;&nbsp;<?=$_['user'];?></a></li>
                                    <li><a href="admin.php?mod=setting"><i
                                                class="fa fa-cog"></i>&nbsp;&nbsp;<?=$_['setting'];?></a></li>
                                    <li class="divider visible-lg"></li>
                                    <li><a href="route.php?mod=home&act=logout"><i
                                                class="fa fa-ban"></i>&nbsp;&nbsp;<?=$_['logout'];?></a></li>
                                </ul>
                            </li>
            ...
            <div class="sidebar-inner slimscrollleft">
                <div id="sidebar-menu">
                    <?php
						...
						$menu = $instance->menu($_SESSION['menuuser'], 'id="main_menu"', '', 'class="list-unstyled"');
						echo $menu;
					?>
    ...
    <script type="text/javascript"
        src="../<?=DIR_INC;?>/js/datatables/extensions/Responsive/js/dataTables.responsive.min.js"></script>
    <script type="text/javascript"
        src="../<?=DIR_INC;?>/js/datatables/extensions/Responsive/js/responsive.bootstrap.min.js"></script>
    ...
    <script type="text/javascript" src="../<?=DIR_INC;?>/js/chained/jquery.chained.js"></script>
    <script type="text/javascript" src="../<?=DIR_INC;?>/js/chained/jquery.chained.remote.js"></script>
